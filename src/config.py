...
class Config(BaseSettings):
    ...
    def validate_basic_auth_username(cls, v, info):
        ...
        if info.data.get("nb_auth_type") == "basic" and not v:
            raise ValueError("nb_auth_username is required when nb_auth_type is 'basic'")
        return v
    ...
    def validate_basic_auth_password(cls, v, info):
        ...
        if info.data.get("nb_auth_type") == "basic" and not v:
            raise ValueError("nb_auth_password is required when nb_auth_type is 'basic'")
        return v
    ...
    def validate_header_auth_name(cls, v, info):
        ...
        if info.data.get("nb_auth_type") == "header" and not v:
            raise ValueError("nb_auth_header_name is required when nb_auth_type is 'header'")
        return v
    ...
    def validate_header_auth_value(cls, v, info):
        ...
        if info.data.get("nb_auth_type") == "header" and not v:
            raise ValueError("nb_auth_header_value is required when nb_auth_type is 'header'")
        return v
